...
<head>
    ...
    <title>Erca Supinho | Profissional Multifacetada</title>
        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    animation: {
                        'arrow-pulse': 'pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite',
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #1a365d 0%, #4c1d95 100%);
            color: #f3f4f6;
            overflow-x: hidden;
        }
        
        .hero-bg {
            background: radial-gradient(circle at 10% 20%, rgba(26, 54, 93, 0.8) 0%, rgba(76, 29, 149, 0.6) 100%);
        }
